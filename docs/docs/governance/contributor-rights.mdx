...
> Historical upstream reference. This is not the development or release policy for Nexus.
> Nexus uses ordinary commits, pulls, and pushes on main, with manual checks and deployments.
