...
export BOT_STT_VOCABULARY="${BOT_STT_VOCABULARY:-}"
export BOT_GMEET_ACCEPT_GEMINI_CONSENT="${BOT_GMEET_ACCEPT_GEMINI_CONSENT:-}"
...
export VEXA_GOOGLE_MEET_IDENTITY="${VEXA_GOOGLE_MEET_IDENTITY:-false}"
